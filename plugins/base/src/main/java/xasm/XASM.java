...
import xasm.base.impl.ASMHelperImpl;
import xasm.base.impl.SimpleOnCoreAddMethodListener;
import xasm.base.impl.common.SysOutLoggerImpl;
import xasm.base.inter.IASMHelper;
import xasm.base.inter.ILogger;
...
public class XASM {
     ...
     * @return
     */
    public CreateClassWrapper createClass(String className, SimpleOnCoreAddMethodListener listener) {
     ...
     * @return
     */
    public CreateClassWrapper createClass(String className, String superClass, String[] interfaces, SimpleOnCoreAddMethodListener listener) {
     ...
     * @return
     */
    public CreateClassWrapper createClass(int javaVersion, String className, String superClass, String[] interfaces, SimpleOnCoreAddMethodListener listener) {
