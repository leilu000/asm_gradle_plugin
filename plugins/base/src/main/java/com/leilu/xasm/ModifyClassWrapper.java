...
import com.leilu.xasm.base.impl.modify.ModifyClassImpl;
...
import com.leilu.xasm.base.inter.IModifyClass;
...
public class ModifyClassWrapper {
     ...
     * @return
     */
    public ModifyClassWrapper addConstructorMethod(int access, String desc, SimpleOnAddMethodListener listener) {
     ...
     * @return
     */
    public ModifyClassWrapper addConstructorMethod(int access, String desc, Class<?>[] exceptions, SimpleOnAddMethodListener listener) {
     ...
     * @return
     */
    public ModifyClassWrapper addMethod(int access, String name, String desc, SimpleOnAddMethodListener listener) {
     ...
     * @return
     */
    public ModifyClassWrapper addMethod(int access, String name, String desc, Class<?>[] exceptions, SimpleOnAddMethodListener listener) {
