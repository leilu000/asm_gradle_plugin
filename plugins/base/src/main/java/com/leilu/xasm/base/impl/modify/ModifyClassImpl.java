...
import com.leilu.xasm.base.impl.add.AddFieldImpl;
import com.leilu.xasm.base.impl.add.AddMethodImpl;
...
public class ModifyClassImpl implements IModifyClass {
    ...
    public ModifyClassImpl(byte[] classData) {
        ...
        mAddField = new AddFieldImpl(mClassWriter);
        mAddMethod = new AddMethodImpl(mClassWriter);
    }
    ...
    public byte[] toByteArray() {
        ...
        ClassVisitor classVisitor = new ClassVisitor(Const.ASM_VERSION, mClassWriter) {
            ...
            public MethodVisitor visitMethod(int access, String name, String descriptor, String signature, String[] exceptions) {
                // 检查方法合法性
                if (ASMUtil.isAbsOrNativeMethod(name, access)) {
            ...
            private void addAnnotation(Object visitor, Map<String, Map<String, Object>> map) {
                if (map != null) {
                    ASMUtil.addAnnotations(visitor, new OnAddFiledListener() {
                        @Override
